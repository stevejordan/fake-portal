        ...
        ns.Helpers = {
            atomDateParser : function (datestr) {
                ...
                var yy   = datestr.substring(0,4),
                    mo   = datestr.substring(5,7),
                    dd   = datestr.substring(8,10),
                    hh   = datestr.substring(11,13),
                    mi   = datestr.substring(14,16),
                    ss   = datestr.substring(17,19),
                    //tzs  = datestr.substring(19,20),
                    //tzhh = datestr.substring(20,22),
                    //tzmi = datestr.substring(23,25),
                    myutc = Date.UTC(yy-0,mo-1,dd-0,hh-0,mi-0,ss-0);
            ...
            debug: function (message) {
                ns.debugging && console.log(message);
            },
